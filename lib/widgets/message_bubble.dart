...
class MessageBubble extends StatelessWidget {
  ...
  const MessageBubble.first(
      this.userImage, this.username, this.message, this.isMe,
      {super.key})
      : isFirstInSequence = true;

  // Create a message bubble that continues the sequence.
  const MessageBubble.next(this.message, this.isMe, {super.key})
                ...
                children: [
                  ...
                  Container(
                    decoration: BoxDecoration(
                      color: isMe
                          ? const Color.fromRGBO(0, 171, 171, 1)
                          : const Color.fromRGBO(168, 255, 255, 1),
